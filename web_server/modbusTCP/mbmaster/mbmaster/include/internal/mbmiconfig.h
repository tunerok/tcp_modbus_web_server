...
#ifndef MBM_FUNC_MASK_WR_REG_ENABLED
#define MBM_FUNC_MASK_WR_REG_ENABLED ( 1 )
#endif
...
#define MBM_SERIAL_RTU_DYNAMIC_WAITAFTERSEND_TIMEOUT_MS( ulBaudRate ) MB_INTDIV_CEIL( 1000UL * 11UL, ulBaudRate )
#endif
...
#define MBM_SERIAL_ASCII_DYNAMIC_WAITAFTERSEND_TIMEOUT_MS( ulBaudRate ) MB_INTDIV_CEIL( 1000UL * 10UL, ulBaudRate )
#endif
