...
#define MB_IS_VALID_HDL( pxHdl, arxHdl )                                                               \
    ( ( ( pxHdl ) != NULL ) && ( ( ( size_t )( ( pxHdl )->ubIdx ) ) < MB_UTILS_NARRSIZE( arxHdl ) ) && \
 ...
 */
eMBErrorCode
eMBExceptionToErrorcode( UBYTE ubMBException );
 ...
 */
BOOL
bMBGuessRTUFrameIsComplete( const UBYTE arubBuffer[], USHORT usLength );
